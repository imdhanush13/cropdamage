...
# Global variable to store prediction result and state
show_prediction = False
prediction_text = 'Minimal Damage'

@main.route('/', methods=['GET', 'POST'])
def home():
    global show_prediction, prediction_text
    if request.method == 'POST':
        ...
        try:
            ...
            prediction_text = f'Predicted Crop Damage: {predicted_crop_damage}'
        
        except Exception as e:
            print(f"Error: {e}")
            show_prediction = False
            prediction_text = "Error in prediction. Please check your input."

    elif request.method == 'GET':
        # Reset the prediction display when "Back" is clicked
        show_prediction = False
        prediction_text = 'Minimal Damage'

    return render_template('index.html', show_prediction=show_prediction, prediction_text=prediction_text)
